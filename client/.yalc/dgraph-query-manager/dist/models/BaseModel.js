...
(function(BaseModelDeletionMode) {
  ...
  BaseModelDeletionMode[(BaseModelDeletionMode['AllChildEdges'] = 3)] =
    'AllChildEdges';
...
class BaseModel {
  ...
  static async createMany(params = []) {
    ...
    try {
      for (
        var params_1 = __asyncValues(params), params_1_1;
        (params_1_1 = await params_1.next()), !params_1_1.done;
  ...
  static async serialize(params = {}) {
    ...
    try {
      for (
        var _c = __asyncValues(Object.keys(params)), _d;
        (_d = await _c.next()), !_d.done;
