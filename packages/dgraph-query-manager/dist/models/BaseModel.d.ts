...
export declare class BaseModel<T> implements BaseModelInterface {
     ...
     */
    static create<T extends typeof BaseModel>(params: Partial<BaseModel<T>>): Promise<Serialization>;
    /**
     * Factory that creates multiple BaseModel instances from BaseModel array.
     * @param {Partial<BaseModel<T>>[]} params
     * @returns {Promise<BaseModel<T>[]>}
     */
    static createMany<T extends typeof BaseModel>(params?: Partial<BaseModel<T>>[]): Promise<BaseModel<T>[]>;
    /**
     ...
     */
    static delete<T extends typeof BaseModel>(this: T, item: Uid | BaseModel<T> | object | string, mode?: BaseModelDeletionMode, edge?: string): Promise<Serialization>;
    /**
     ...
     * @returns {Promise<Serialization>}
     */
    static find<T extends typeof BaseModel>(this: T, params: BaseModel<T> | Uid | string | number): Promise<Serialization>;
    /**
     ...
     */
    static fromJSON<T extends typeof BaseModel>(this: T, json: object | string): InstanceType<T>;
    /**
     ...
     */
    static getDeletionRequest<T extends typeof BaseModel>(params: BaseModel<T> | any, mode?: BaseModelDeletionMode, edge?: string): object | undefined;
    /**
     ...
     * @returns {InstanceType<T>}
     */
    static injectDefaults<T extends typeof BaseModel>(this: T, params?: Partial<T>): InstanceType<T>;
    /**
     ...
     * @returns {Promise<Serialization>}
     */
    static insert<T>(params?: Partial<T>, params2?: Partial<T> | object): Promise<Serialization>;
    /**
     ...
     * @returns {boolean}
     */
    static isResponseValid<T extends typeof BaseModel>(this: T, response: object): boolean;
    /**
     * Invokes async BaseModel<T> creation process.
     * @param {Partial<BaseModel<T>>} params
     * @returns {Promise<Partial<BaseModel<T>>>}
     */
    static load<T>(params?: Partial<BaseModel<T>>): Promise<Partial<BaseModel<T>>>;
    /**
     ...
     * @returns {Promise<Serialization>}
     */
    static upsert<T>(params?: Partial<T>, params2?: Partial<T> | object): Promise<Serialization>;
}
